<%@ Page Title="" Language="C#" MasterPageFile="~/Student/StudentMaster.Master" AutoEventWireup="true" CodeBehind="StudentDashboard.aspx.cs" Inherits="Scheduler2.Student.StudentDashboard" %>
<%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="asp" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  <asp:ModalPopupExtender ID="ModalPopupExtender1" runat="server"
  TargetControlID="Button7" PopupControlID="btnClose"></asp:ModalPopupExtender>  
    ...
    <asp:ModalPopupExtender ID="modulPopup" runat="server" TargetControlID="Button7"
        PopupControlID="pnlCities" CancelControlID="btnClose" BackgroundCssClass="modalBackground" DropShadow="true">
    </asp:ModalPopupExtender>
    <asp:Panel ID="pnlCities" runat="server" 
        style="border: groove; background-color: #F0F0F0; border-width: 1px; border-color: #C0C0C0;" 
        Width="444px">
        <table width="100%">
            <tr>
                <td>
...
&nbsp;</td>
                <td>
                    <asp:Label ID="lblAppointement" runat="server" class="loginLabelStyle" 
                        Font-Size="Medium" ForeColor="Black" Text="Appointment: "></asp:Label>
                    &nbsp;&nbsp;
                    <asp:Label ID="Label1" runat="server" class="loginLabelStyle" 
                        Font-Size="Medium" ForeColor="Black" Text="Friday, 11/16/2012 At 3:00PM "></asp:Label>
                </td>
                <td>
                    &nbsp;</td>
            </tr>
            <tr>
                <td>
                    ...
                    &nbsp;</td>
                <td>
                    <asp:Label ID="Label2" runat="server" class="loginLabelStyle" 
                        Font-Size="Medium" ForeColor="Black" Text="Tutor: "></asp:Label>
                    &nbsp;&nbsp;
                    <asp:Label ID="Label3" runat="server" class="loginLabelStyle" 
                        Font-Size="Medium" ForeColor="Black" Text="Tyler Fehnel"></asp:Label>
                </td>
                <td>
                    &nbsp;</td>
            </tr>
            <tr>
                ...
                <td>
                    ...
                    <asp:Button ID="btnScheduleApp" runat="server" Class="menuButtonStyle" 
                        Text="Schedule" />
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:Button ID="btnClose" runat="server" Class="menuButtonStyle" 
                        Text="Cancel" />
                </td>
                <td>
                    &nbsp;</td>
