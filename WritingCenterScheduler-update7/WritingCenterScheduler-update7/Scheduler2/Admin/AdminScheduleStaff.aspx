<%@ Page Title="" Language="C#" MasterPageFile="AdminMaster.Master" AutoEventWireup="true" CodeBehind="AdminScheduleStaff.aspx.cs" Inherits="Scheduler2.Admin.AdminScheduleStaff" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table cellpadding="0" cellspacing="0" align="center" 
        ...
        <b>To Schedule Staff Member:</b></td></tr>
        <tr> <td>
        ...
        <tr> <td>
            3. Select a begin time and end time for each day</td></tr>
        <tr> <td>
            4. Click submit</td></tr>
                </table>
            </td>
        </tr>
        <tr __designer:mapid="15b">
            ...
            <td bgcolor="White" __designer:mapid="15d" align="center" 
                ...
                <asp:Label ID="lblMonday0" runat="server" Text="Begin Time"></asp:Label>
                    <asp:DropDownList ID="DropDownList2" runat="server" Height="24px" Width="110px">
                    </asp:DropDownList>
                <br />
                <br />
            </td>
            <td bgcolor="White" colspan="2" __designer:mapid="15e" 
                ...
                <asp:Label ID="lblMonday12" runat="server" Text="Begin Time"></asp:Label>
                    <asp:DropDownList ID="DropDownList4" runat="server" Height="24px" Width="110px">
                    </asp:DropDownList>
                <br />
                <br />
            </td>
            <td bgcolor="White" __designer:mapid="15f" align="center" 
                ...
                <asp:Label ID="lblMonday13" runat="server" Text="Begin Time"></asp:Label>
                    <asp:DropDownList ID="DropDownList6" runat="server" Height="24px" Width="110px">
                    </asp:DropDownList>
                <br />
                <br />
            </td>
            <td bgcolor="White" __designer:mapid="160" align="center" 
                ...
                <asp:Label ID="lblMonday14" runat="server" Text="Begin Time"></asp:Label>
                    <asp:DropDownList ID="DropDownList7" runat="server" Height="24px" Width="110px">
                    </asp:DropDownList>
                <br />
                <br />
            </td>
            <td bgcolor="White" __designer:mapid="161" align="center" 
                ...
                <asp:Label ID="lblMonday15" runat="server" Text="Begin Time"></asp:Label>
                    <asp:DropDownList ID="DropDownList8" runat="server" Height="24px" Width="110px">
                    </asp:DropDownList>
                <br />
                <br />
            </td>
            <td align="center" class="cellStyle">
                ...
                <br />
                <asp:DropDownList ID="DropDownList9" runat="server" Height="24px" Width="110px">
                </asp:DropDownList>
                <br />
                <br />
                <br />
        ...
        <tr __designer:mapid="15b">
            <td bgcolor="White" __designer:mapid="15d" align="center" 
                ...
                <asp:Label ID="lblMonday1" runat="server" Text="End Time"></asp:Label>
                    <asp:DropDownList ID="DropDownList3" runat="server" Height="24px" Width="110px">
                    </asp:DropDownList>
                <br />
                <br />
            </td>
            <td bgcolor="White" colspan="2" __designer:mapid="15e" 
                ...
                <asp:Label ID="lblMonday17" runat="server" Text="End Time"></asp:Label>
                    <asp:DropDownList ID="DropDownList5" runat="server" Height="24px" Width="110px">
                    </asp:DropDownList>
                <br />
                <br />
            </td>
            <td bgcolor="White" __designer:mapid="15f" align="center" 
                ...
                <asp:Label ID="lblMonday18" runat="server" Text="End Time"></asp:Label>
                    <asp:DropDownList ID="DropDownList10" runat="server" Height="24px" 
                        Width="110px">
                    </asp:DropDownList>
                <br />
                <br />
            ...
            <td bgcolor="White" __designer:mapid="161" align="center" 
                ...
                <asp:Label ID="lblMonday20" runat="server" Text="End Time"></asp:Label>
                    <asp:DropDownList ID="DropDownList12" runat="server" Height="24px" 
                        Width="110px">
                    </asp:DropDownList>
                <br />
                <br />
            ...
            <td align="center" class="cellStyle">
                ...
                <br />
                <asp:DropDownList ID="DropDownList13" runat="server" Height="24px" 
                    Width="110px">
                </asp:DropDownList>
